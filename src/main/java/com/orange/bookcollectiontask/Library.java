...
public class Library {
    ...
    public void removeBook(int elementPosition) {
        try {
            ...
            System.out.println("The book was deleted: " + deletedBook.getTitle());
        } catch (IndexOutOfBoundsException exceptionObject) {
            System.out.println("Please verify the index: " + exceptionObject.getMessage());
        }
    }
    ...
    public void removeBook(Book removedBook) {
        ...
        if (isDeleted) {
            System.out.println("The deleted book is: " + removedBook.getTitle());
        } else {
   ...
   public void printAllTheBooks (){
        for (int i=0; i<bookList.size(); i++){
            System.out.println("The book no: " + i+ " is: "+ bookList.get(i).getTitle()+ " by "+
